 ...
 */
async function fetchSingleFund(fundId) {
    try {
 ...
 */
async function fetchAndStoreHistory(fundId, period = "1Y") {
    try {
 ...
 */
export async function scanAndDiscoverFunds(start = 1, end = 5000) {
    let discovered = 0;
    let errors = 0;
...
//# sourceMappingURL=nav-fetcher.js.map